...
* **Two-Way Data Sync**: Dynamically send data from the parent to the dialog, and from the dialog back to the parent, while the dialog is open.  
* **Action Control**: Trigger named actions in the dialog from the parent, and vice-versa, allowing for complex interactive workflows.  
* **Type Safety**: Fully typed inputs, outputs, and dialog component instances for a robust development experience.  
* **Reactive Streams**: Built on RxJS Observables for efficient and declarative data flow.  
* **Seamless Integration**: Extends Angular Material's MatDialog without requiring significant changes to your existing dialog components.
...
\`\`\`html  
\<\!-- src/app/parent-component/parent.component.html \--\>  
...
Inject MAT\_DIALOG\_DATA and DialogSyncRef into your dialog component.

// src/app/my-dialog/my-dialog.component.ts  
import { Component, Inject, OnDestroy, OnInit } from '@angular/core';  
import { MAT\_DIALOG\_DATA, MatDialogRef } from '@angular/material/dialog';  
...
export class MyDialogComponent implements OnInit, OnDestroy {  
  ...
  constructor(  
    @Inject(MAT\_DIALOG\_DATA) public data: MatDialogDefaultData & { \_syncDataSubject: any; \_actionSubject: any; \_parentDataSubject: any; initialData: MyDialogInput },  
